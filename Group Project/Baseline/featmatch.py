...
def FeatMatch(opts, data_files=[]): 
    ...
    for i, img_path in enumerate(img_paths): 
        ...
        elif opts.features == "SURF":
            feat = cv2.xfeatures2d.SURF_create()
        else:
            raise ValueError("Unsupported feature type: {}".format(opts.features))
...
def SetArguments(parser): 
    ...
    parser.add_argument('--data_dir',action='store',type=str,default='../data/white/images/',
    ...
    parser.add_argument('--ext',action='store',type=str,default='jpg,png,jpeg,JPG',dest='ext',
                        ...
                        (default: jpg,png)') 
    parser.add_argument('--out_dir',action='store',type=str,default='../data/white/',
